...
class WidgetFailDialog extends StatelessWidget {
  const WidgetFailDialog({super.key});

  // void showWidgetFailDialog(BuildContext context) {
  //   showGeneralDialog(
  //     context: context,
      ...
      child: Padding(
        ...
        child: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                child: Image.asset('assets/images/fail.png', fit: BoxFit.cover),
              ),
