...
import 'package:kunft/provider/logement_provider.dart'; // Correction du chemin d'import si nécessaire
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<LogementProvider>(
      builder: (context, logementProvider, child) {
        ...
        final bool isLoading = logementProvider.isLoadingMainLogements;
...
// // --- Fonction de récupération de TOUS les logements ---
// // Copie de la fonction fetchLogements de HomeScreen, adaptée si nécessaire.
// // Elle doit inclure le token d'authentification si la route Laravel est protégée.
// Future<List<dynamic>> fetchAllLogements() async {
//   try {
...
//       '$API_BASE_URL/api/logements', // Assurez-vous que cette URL est correcte pour TOUS les logements
//       options: Options(
//         headers: {
...
//     print('DEBUG: API Call /logements (TousLogements)...');
...
//     }
//   } catch (e) {
//     print('DEBUG: Erreur inattendue lors du fetch de tous les logements: $e');
...
//   void initState() {
//     super.initState();
//     _chargerTousLogements();
//   }

//   Future<void> _chargerTousLogements() async {
//     setState(() {
//       isLoading = true;
...
//     try {
//       final data =
//           await fetchAllLogements(); // Appel de la fonction de récupération
//       setState(() {
//         logements = data;
//         isLoading = false;
//       });
//       print('DEBUG: Tous les logements chargés : ${logements.length}');
//     } catch (e) {
//       print('DEBUG: Erreur lors du chargement de tous les logements: $e');
//       setState(() {
//         isLoading = false;
//         errorMessage = 'Impossible de charger les logements : $e';
//       });
//       if (mounted) {
