...
// ✅ MODIFIÉ : Importez la constante API_BASE_URL directement depuis le fichier du provider
...
class _PropertyDetailState extends State<PropertyDetail> {
  ...
  void initState() {
    super.initState();
    _extractAllImageUrls(); // Cette fonction utilisera maintenant la constante importée
    ...
    if (widget.logementData['images'] is List) {
      for (var image in widget.logementData['images']) {
        if (image['image_path'] != null) {
          // ✅ MODIFIÉ : Utilise la constante API_BASE_URL importée
  ...
  Widget build(BuildContext context) {
    // Consomme le LogementProvider pour accéder aux helpers de formatage
                            ...
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const Spacer(),
                                  // Passe les données du logement complètes à WidgetHouseTextInfos2
